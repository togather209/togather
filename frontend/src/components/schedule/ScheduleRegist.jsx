    ...
    <div className="schedule-regist">
      <div className="schedule-regist-container-box">
        ...
        <div className="schedule-regist-header">
          ...
          <p className="schedule-regist-header-desc-text">
            일정 정보를 입력해주세요
          </p>
        </div>
        ...
        <form className="schedule-regist-form" action="">
          <div className="schedule-regist-form-date-input">
            <p className="schedule-regist-form-date-input-text">
              일정 시작일 및 종료일
            </p>
            <DatePicker
              startDate={startDate}
          ...
          <div className="schedule-regist-input-box">
            ...
            <input
              ...
              className="schedule-regist-input-tag"
              type="text"
              placeholder="일정명"
            />
          </div>
          ...
          <Button type={"purple"} onClick={addSchedule}>
            생성
          </Button>
        </form>
      </div>
