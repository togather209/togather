...
function MeetingCard({id, image_url, name, desc, admin, isCheckModalOpen, handelCheckModalOpen, setIsCheckModalOpen, isExitModalOpen, setIsExitModalOpen, handleExitModalOpen}) {
        ...
        <div className="meeting-card">
            ...
            <div className="button-section">
                { admin ? (
                    ...
                    <button onClick={handleExitModalOpen} className="meeting-card-button-form"><img className="update-button" src={Out} alt="나가기버튼" /></button>
                )}
            </div>
        </div>
